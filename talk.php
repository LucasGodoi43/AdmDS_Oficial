...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        // Mensagem de sucesso - aqui você pode usar um SweetAlert, mas será necessário redirecionar após isso.
        // header("Location: index.html"); // Redireciona após o sucesso
        // exit; // Para garantir que o código PHP pare aqui
    } else {
